    ...
    <div className={clsx("custom-flex-col gap-2", className)}>
      ...
      <div className="relative flex items-center">
        ...
        <input
          ...
          // Input styles
          className={clsx(
            "p-3 rounded-[4px] w-full custom-primary-outline border border-solid border-[#C1C2C366] bg-neutral-2 hover:border-[#00000099] transition-colors duration-300 ease-in-out",
            {
