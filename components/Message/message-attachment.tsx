...
const MessageAttachment: React.FC<{onEmojiSelect: (emoji: string) => void}> = ({onEmojiSelect}) => {
    ...
    const options = [
      ...
      },
      {
        name: "Gallery",
        icon: <GalleryIcon />,
        component: <MessageGalleryComponent />,
        heading: "Gallery",
      },
      {
        name: "Audio",
      ...
      },
      {
        name: "Document",
        icon: <DocumentIcon />,
        component: <MessageDocumentComponent />,
        heading: "Document"
      },
    ];
    ...
    if (activeStep === 1) {
      ...
      return (
        <MessageModalPreset heading={selectedHeading} back={{ handleBack: () => changeStep(1) }}>
            {SelectedComponent}
        </MessageModalPreset>
      );
    }
