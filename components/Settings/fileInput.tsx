    ...
    <div className={clsx("custom-flex-col gap-2", className)}>
      ...
      <div className="relative flex items-center w-full">
        ...
        <div
          ...
          onClick={handleClick}
          className={clsx(
            "p-3 rounded-[8px] w-full h-[45px] border border-solid border-[#C1C2C366] text-text-disabled text-xs md:text-sm font-normal overflow-hidden whitespace-nowrap text-ellipsis flex items-center justify-between hover:border-[#00000099] transition-colors duration-300 ease-in-out",
