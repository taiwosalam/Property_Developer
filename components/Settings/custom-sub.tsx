  ...
  return (
    <div className="flex flex-col w-full pr-10 pl-4 rounded-md mt-8 flex-wrap shadow-md py-4 bg-[url('/icons/enrollment-bg.svg')] bg-no-repeat bg-center bg-cover bg-opacity-60">
      ...
      <p className="text-sm max-w-[964px] text-text-secondary dark:text-darkText-1">
        If none of the available plans meets your company&apos;s standards, consider
        opting for the Professional plan. This plan provides unlimited access to
        all software solutions. Professional plans are ideal for established
        property managers who wish to customize the software with their
