...
// =============== PROPERTY PRICING =================
// export const PropertyPricing = ({ unitData }: { unitData?: any }) => {
//   const [currency, setCurrency] =
//     useState<keyof typeof currencySymbols>("naira");
//   const CURRENCY_SYMBOL = currencySymbols[currency];
...
//   const { rentAmount, inspectionFee, agencyFee, serviceCharge } = formValues;
...
//           onChange={(val) => setCurrency(val as keyof typeof currencySymbols)}
//           isSearchable={false}
//           inputContainerClassName="bg-white"
//           requiredNoStar
//           hiddenInputClassName="property-form-input"
