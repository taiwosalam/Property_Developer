...
const UploadSignature: React.FC<AddMultipleLandlordsOrTenantsProps> = ({
  type,
  method,
  submitAction,
}) => {
    ...
    <>
      ...
      <div className="flex justify-end gap-4 items-center">
        <p className="text-sm font-normal">
          Please sign on a plain white paper and take a photo for uploading. If
          possible, remove the background picture of the signature before
          uploading for a cleaner appearance.
        </p>
        <Button
          type="button"
