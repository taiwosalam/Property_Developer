...
const RelocateModal = () => {
  return (
    <div className="w-[500px] max-w-[90%] rounded-[10px] bg-white dark:bg-darkText-primary overflow-hidden">
      {/* Header */}
      <div className="bg-status-success-1 dark:bg-[#3c3d37] px-4 py-3">
      ...
      <div className="px-4 py-6">
        <p className="text-sm mb-6 h-[200px] dark:text-darkText-1">
