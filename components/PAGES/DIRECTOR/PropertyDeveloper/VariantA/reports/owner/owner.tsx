...
const PropertyDeveloperOwnerReportVariantA = () => {
  ...
  return (
    <div className="space-y-9">
      ...
      <FilterBar
        ...
        aboutPageModalData={{
          title: "client",
          description: "This page contains a list of client on the platform.",
        }}
      ...
      {tableData.length > 0 ? (
        ...
        <section>
          <EmptyList
            ...
            body={
              <p>
                There are currently no Client records. This section will
                automatically update with Client information as it becomes
                ...
                Once activity begins, all relevant Client logs will appear here.
              </p>
            }
          />
        </section>
...
export default PropertyDeveloperOwnerReportVariantA;
