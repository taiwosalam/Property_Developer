...
import { updateProperty } from "@/app/(nav)/management/properties/[id]/edit-property/data";
import { SinglePropertyResponse } from "@/app/(nav)/management/properties/[id]/data";
import { transformPropertyData } from "@/app/(nav)/manager/management/properties/create-rental-property/[propertyId]/add-unit/data";

const PropertyManagerEditPropertyVariantA = ({
  propertyId,
}: {
  propertyId: string;
}) => {
...
export default PropertyManagerEditPropertyVariantA;
