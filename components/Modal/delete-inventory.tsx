  ...
  return (
    <ModalPreset type="warning">
      <p className="text-text-disabled text-sm font-normal">
        {desc ||
          "Are you sure you want to proceed with deleting this inventory list? *Please note that you can only delete inventory that has not yet been linked with a property."}
      </p>
  ...
  return (
    <>
      <div className="p-5 custom-flex-col gap-4 rounded-2xl bg-white dark:bg-black overflow-hidden max-w-[486px]">
        <h1 className="text-brand-9 dark:text-white text-xl font-bold capitalize">
          Warning!
        </h1>
        <p className="text-text-disabled text-sm font-normal">
          Are you sure you want to proceed with deleting this article? Please
        ...
        <div className="flex items-end justify-end gap-2 w-full">
          ...
          <ModalTrigger
            ...
            className="text-brand-primary text-sm font-medium px-3"
          >
            <button className="px-8 py-2 bg-text-disabled rounded-md text-white">
              Cancel
            </button>
          </ModalTrigger>
        </div>
...
export const DeleteInventoryModalSuccess = () => {
  return (
    <ModalPreset type="success">
      <p className="text-text-disabled text-sm font-normal">
        <span className="capitalize">inventory list</span> The list has been
...
export const DeleteArticleModalSuccess = ({
  open,
  handleClose,
}: {
  open: boolean;
      ...
      >
        <Box sx={style}>
          <div className="custom-flex-col gap-8 items-center justify-center">
            <p className="text-text-disabled text-md font-normal text-center">
              {" "}
              The article has been successfully deleted.
            </p>
            <button
              className="bg-brand-9 text-white px-8 py-2 rounded-md"
              onClick={handleClose}
            >
              ok
            </button>
...
export const DeletePropertyRequestModalSuccess = ({
  open,
  handleClose,
}: {
  open: boolean;
      ...
      >
        <Box sx={style}>
          <div className="custom-flex-col gap-8 items-center justify-center">
            <p className="text-text-disabled text-md font-normal text-center">
              {" "}
              The Property request has been successfully deleted.
            </p>
            <button
              className="bg-brand-9 text-white px-8 py-2 rounded-md"
              onClick={handleClose}
