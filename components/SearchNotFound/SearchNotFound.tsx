  ...
  return (
    <div className="flex flex-col gap-[15px] mt-12 px-20">
      ...
      <div className="flex flex-col gap-7 text-text-secondary dark:text-darkText-2 font-normal text-sm">
        <p>
          We couldn&rsquo;t find any results matching your search. Here are some
          suggestions to help you refine your search or find what you&rsquo;re
          looking for:
        </p>
        ...
        <div className="flex flex-col gap-2">
          ...
          <ol className="list-decimal pl-6 space-y-2">
            <li>
              The keywords or query entered may not match any content in
              database.
            </li>
            <li>
              The item, service, or content you&rsquo;re searching for may not
              exist on the platform.
            </li>
            <li>
              There may be a typo or error in the search terms you entered.
            </li>
          </ol>
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <ol className="list-decimal pl-6 space-y-2">
            ...
            <li>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  Simplify your query to improve the chances of finding relevant
                  matches.
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  Explore the available filter option to locate what you need.
                </li>
              </ul>
            </li>
            <li>
