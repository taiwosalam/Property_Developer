...
export const user_nav_items: NavItemsProps = [
  ...
  },
  {
    ...
    content: [
      ...
      { label: 'tenants & occupants', href: '/user/management/tenants' },
      { label: 'branch Staff', href: '/user/management/staff-branch' },
      { label: 'inventory', href: '/user/management/inventory' },
      { label: 'properties', href: '/user/management/properties' },
      { label: 'rent & unit', href: '/user/management/rent-unit' },
      {
        label: 'service providers',
        href: '/user/management/service-providers',
      },
      { label: 'vehicles record', href: '/user/management/vehicles-record' },
      { label: 'team chat', href: '/user/management/team-chat' },
      { label: 'agent community', href: '/management/agent-community' },
    ],
  },
  {
