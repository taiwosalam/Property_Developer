...
const CreateRecordModal = () => {
  return (
    <div className="w-[600px] max-w-[80%] h-[420px] max-h-[85%] rounded-2xl overflow-x-auto custom-round-scrollbar font-medium bg-white p-4 flex items-stretch gap-4">
      <div className="w-[37.5%] h-full overflow-x-auto space-y-2 no-scrollbar">
      ...
      <div className="flex-1 flex flex-col items-center justify-between gap-7 h-full pb-4">
        <ModalTrigger
          close
          type="button"
          aria-label="Close"
