        ...
        {type === "manual" ? (
          ...
          <div className="grid gap-4 md:gap-5 md:grid-cols-2 lg:grid-cols-3">
            <div className="flex flex-col gap-2">
              <label> Input Guest/Visitor ID </label>
              ...
              <input type="text" className="w-full h-full rounded-[4px] outline-none px-2" />
              <button className='bg-brand-9 text-xs rounded-md px-2 text-white h-3/4'> Submit </button>
              </div>
            </div>
          <Select
