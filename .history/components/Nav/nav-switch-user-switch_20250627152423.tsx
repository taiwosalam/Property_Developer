      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            style={{ boxShadow: "0px 2px 4px 0px rgba(0, 0, 0, 0.1)" }}
            className={`absolute top-full z-50 left-1/2 -translate-x-1/2 w-[220px] min-w-[180px] md:left-0 md:translate-x-0 md:w-full py-2 bg-white dark:bg-[#3C3D37] rounded-bl-lg rounded-br-lg
            `}
