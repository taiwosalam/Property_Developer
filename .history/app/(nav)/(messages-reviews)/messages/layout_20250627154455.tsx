            ...
            {id && (
              <AuthForm onFormSubmit={() => {}}>
                <div className="py-4 px-6 flex w-full items-center gap-4">
                  ...
                  {message ? (
                    <button type="button" className="text-brand-9" onClick={handleSendMsg}>
                      {reqLoading ? (
                        <div className="animate-spin h-5 w-5 border-2 border-brand-9 rounded-full" />
                      ) : (
                        <MessageSendIcon size={24} />
                      )}
                    </button>
                  ) : (
                    <>
                      ...
                      <div className="flex gap-2">
                        <button type="button" onClick={onPlayPause}>
                          {/* <Picture
                            ...
                            size={24}
                          /> */}
                          {isPlaying ? <MessageVNPlayIcon size={30} /> : <MessageVNPlayIcon size={30} />}
                        </button>
                        <button
                          type="button"
