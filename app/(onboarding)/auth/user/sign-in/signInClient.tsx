...
const SignIn = () => {
  ...
  const localDomain = getLocalStorage("company_domain");
  const domain = usePersonalInfoStore((state) => state.company_domain) || localDomain;
  ...
  return (
    ...
    >
      <AuthHeading title="welcome Back" logo={logo}>
      ...
      <div className="flex items-center justify-between">
        ...
        <Button
          ...
          size="base_bold"
          variant="default"
          className="py-xs px-lg mt-2 ml-auto"
        >
