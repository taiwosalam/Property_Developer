  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-brand-1">
      ...
      <div className="relative h-full flex gap-10 p-[20px] sm:p-[60px]">
        ...
        >
          <div className="w-full max-w-[580px] pb-6 px-xl rounded-2xl bg-white dark:bg-darkText-primary max-h-full overflow-x-hidden overflow-y-auto custom-round-scrollbar">
            {children}
          </div>
        </div>
        {!isUserSignInPage && (
