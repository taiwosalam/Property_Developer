        ...
        {properties.length === 0 && !silentLoading ? (
          isFilterApplied() || search ? (
            ...
            <EmptyList
              ...
              body={
                <p>
                  To add a property to this branch, click the &apos;Add
                  Property&apos;s button. You can create two types of
                  properties: rental and facility properties. During the
                  creation process, select this branch name in the branch input
                  section under property details.
                </p>
              }
            />
          )
