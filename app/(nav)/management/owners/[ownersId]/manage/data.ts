...
export interface IndividualOwnerAPIResponse {
    data: {
        id: string;
        name: string;
        title: string;
...
export const generateDummyIndividualOwnerAPIResponse = (id: string): IndividualOwnerAPIResponse => {
    ...
    return {
        data: {
            ...
            note: {
                ...
                note: "Premium property owner with multiple investments",
            },
            bank_details: {
...
export const updateOwnerWithEmailOrID = async (data: any, id: number) => {
    try {
        // Dummy implementation - would be replaced with actual API call
        console.log("Updating owner with data:", data, "ID:", id);
        return true;
    } catch (error) {
