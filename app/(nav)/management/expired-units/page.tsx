...
import { initialState, RentAndUnitFilters, RentAndUnitFiltersWithDropdown, RentAndUnitState, RentUnitFilterParams, transformRentUnitApiResponse, UnitApiResponse, UnitFilterResponse, UnitPageState } from "../rent-unit/data";
                    ...
                    {pageData?.unit.length === 0 && !silentLoading ? (
                        isFilterApplied() || search ? (
                            ...
                            <EmptyList
                                ...
                                body={
                                    <p>
                                        This could mean that all units are currently active, there are no outstanding tenant or occupant payments, or no units have been created yet.
                                    </p>
                                }
                            />
                        )
