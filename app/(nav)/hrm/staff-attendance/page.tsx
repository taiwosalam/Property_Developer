...
const PropertyDeveloperLogbookUserVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantA/hrm/StaffAttendance"
    ),
  { ssr: false }
);
const PropertyDeveloperLogbookUserVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantB/hrm/StaffAttendance"
    ),
  { ssr: false }
);
const PropertyDeveloperLogbookUserVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantC/hrm/StaffAttendance"
    ),
  { ssr: false }
);
...
const HospitalityManagementLogbookUserVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantA/hrm/StaffAttendance"
    ),
  { ssr: false }
);
const HospitalityManagementLogbookUserVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantB/hrm/StaffAttendance"
    ),
  { ssr: false }
);
const HospitalityManagementLogbookUserVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantC/hrm/StaffAttendance"
    ),
  { ssr: false }
);
