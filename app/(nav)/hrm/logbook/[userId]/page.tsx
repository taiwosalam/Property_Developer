...
const PropertyDeveloperLogbookUserVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantA/hrm/LogbookUser"
    ),
  { ssr: false }
);
const PropertyDeveloperLogbookUserVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantB/hrm/LogbookUser"
    ),
  { ssr: false }
);
const PropertyDeveloperLogbookUserVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantC/hrm/LogbookUser"
    ),
  { ssr: false }
);
...
const HospitalityManagementLogbookUserVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantB/hrm/LogbookUser"
    ),
  { ssr: false }
);
const HospitalityManagementLogbookUserVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantC/hrm/LogbookUser"
    ),
  { ssr: false }
);
