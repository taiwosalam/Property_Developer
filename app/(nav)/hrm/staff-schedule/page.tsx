...
const PropertyDeveloperLogbookUserVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantA/hrm/StaffSchedule"
    ),
  { ssr: false }
);
const PropertyDeveloperLogbookUserVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantB/hrm/StaffSchedule"
    ),
  { ssr: false }
);
const PropertyDeveloperLogbookUserVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantC/hrm/StaffSchedule"
    ),
  { ssr: false }
);
...
const HospitalityManagementLogbookUserVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantA/hrm/StaffSchedule"
    ),
  { ssr: false }
);
const HospitalityManagementLogbookUserVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantB/hrm/StaffSchedule"
    ),
  { ssr: false }
);
const HospitalityManagementLogbookUserVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantC/hrm/StaffSchedule"
    ),
  { ssr: false }
);
