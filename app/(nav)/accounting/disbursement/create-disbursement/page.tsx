...
const PropertyManagerDisbursementVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyManager/variantA/accounting/disbursement/create-disbursement/create-disbursement-page"
    ),
  { ssr: false }
);
const PropertyManagerDisbursementVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyManager/VariantB/accounting/disbursement/create-disbursement/create-disbursement-page"
    ),
  { ssr: false }
);
const PropertyManagerDisbursementVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyManager/VariantC/accounting/disbursement/create-disbursement/create-disbursement-page"
    ),
  { ssr: false }
);
...
const PropertyDeveloperDisbursementVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantA/accounting/disbursement/create-disbursement/create-disbursement-page"
    ),
  { ssr: false }
);
const PropertyDeveloperDisbursementVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantB/accounting/disbursement/create-disbursement/create-disbursement-page"
    ),
  { ssr: false }
);
const PropertyDeveloperDisbursementVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantC/accounting/disbursement/create-disbursement/create-disbursement-page"
    ),
  { ssr: false }
);
...
const HospitalityManagementDisbursementVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantA/accounting/disbursement/create-disbursement/create-disbursement-page"
    ),
  { ssr: false }
);
const HospitalityManagementDisbursementVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantB/accounting/disbursement/create-disbursement/create-disbursement-page"
    ),
  { ssr: false }
);
const HospitalityManagementDisbursementVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantC/accounting/disbursement/create-disbursement/create-disbursement-page"
    ),
  { ssr: false }
);
