...
const PropertyManagerDisbursementVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyManager/variantA/accounting/disbursement/disbursement-page"
    ),
  { ssr: false }
);
const PropertyManagerDisbursementVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyManager/VariantB/accounting/disbursement/disbursement-page"
    ),
  { ssr: false }
);
const PropertyManagerDisbursementVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyManager/VariantC/accounting/disbursement/disbursement-page"
    ),
  { ssr: false }
);
...
const PropertyDeveloperDisbursementVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantA/accounting/disbursement/disbursement-page"
    ),
  { ssr: false }
);
const PropertyDeveloperDisbursementVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantB/accounting/disbursement/disbursement-page"
    ),
  { ssr: false }
);
const PropertyDeveloperDisbursementVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantC/accounting/disbursement/disbursement-page"
    ),
  { ssr: false }
);
...
const HospitalityManagementDisbursementVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantA/accounting/disbursement/disbursement-page"
    ),
  { ssr: false }
);
const HospitalityManagementDisbursementVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantB/accounting/disbursement/disbursement-page"
    ),
  { ssr: false }
);
const HospitalityManagementDisbursementVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantC/accounting/disbursement/disbursement-page"
    ),
  { ssr: false }
);
