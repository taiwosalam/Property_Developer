...
const PropertyManagerInvoiceVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyManager/variantA/accounting/invoice/create-invoice/create-invoice-page"
    ),
  { ssr: false }
);
const PropertyManagerInvoiceVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyManager/VariantB/accounting/invoice/create-invoice/create-invoice-page"
    ),
  { ssr: false }
);
const PropertyManagerInvoiceVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyManager/VariantC/accounting/invoice/create-invoice/create-invoice-page"
    ),
  { ssr: false }
);
...
const PropertyDeveloperInvoiceVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantA/accounting/invoice/create-invoice/create-invoice-page"
    ),
  { ssr: false }
);
const PropertyDeveloperInvoiceVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantB/accounting/invoice/create-invoice/create-invoice-page"
    ),
  { ssr: false }
);
const PropertyDeveloperInvoiceVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantC/accounting/invoice/create-invoice/create-invoice-page"
    ),
  { ssr: false }
);
...
const HospitalityManagementInvoiceVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantA/accounting/invoice/create-invoice/create-invoice-page"
    ),
  { ssr: false }
);
const HospitalityManagementInvoiceVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantB/accounting/invoice/create-invoice/create-invoice-page"
    ),
  { ssr: false }
);
const HospitalityManagementInvoiceVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantC/accounting/invoice/create-invoice/create-invoice-page"
    ),
  { ssr: false }
);
