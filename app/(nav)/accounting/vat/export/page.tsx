...
const PropertyManagerVATVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyManager/variantA/accounting/vat/export/export-page"
    ),
  { ssr: false }
);
const PropertyManagerVATVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyManager/VariantB/accounting/vat/export/export-page"
    ),
  { ssr: false }
);
const PropertyManagerVATVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyManager/VariantC/accounting/vat/export/export-page"
    ),
  { ssr: false }
);
...
const PropertyDeveloperVATVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantA/accounting/vat/export/export-page"
    ),
  { ssr: false }
);
const PropertyDeveloperVATVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantB/accounting/vat/export/export-page"
    ),
  { ssr: false }
);
const PropertyDeveloperVATVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantC/accounting/vat/export/export-page"
    ),
  { ssr: false }
);
...
const HospitalityManagementVATVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantA/accounting/vat/export/export-page"
    ),
  { ssr: false }
);
const HospitalityManagementVATVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantB/accounting/vat/export/export-page"
    ),
  { ssr: false }
);
const HospitalityManagementVATVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantC/accounting/vat/export/export-page"
    ),
  { ssr: false }
);
