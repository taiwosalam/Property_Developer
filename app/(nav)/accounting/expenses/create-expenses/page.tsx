...
const PropertyManagerExpensesVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyManager/variantA/accounting/expenses/create-expenses/create-page"
    ),
  { ssr: false }
);
const PropertyManagerExpensesVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyManager/VariantB/accounting/expenses/create-expenses/create-page"
    ),
  { ssr: false }
);
const PropertyManagerExpensesVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyManager/VariantC/accounting/expenses/create-expenses/create-page"
    ),
  { ssr: false }
);
...
const PropertyDeveloperExpensesVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantA/accounting/expenses/create-expenses/create-page"
    ),
  { ssr: false }
);
const PropertyDeveloperExpensesVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantB/accounting/expenses/create-expenses/create-page"
    ),
  { ssr: false }
);
const PropertyDeveloperExpensesVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantC/accounting/expenses/create-expenses/create-page"
    ),
  { ssr: false }
);
...
const HospitalityManagementExpensesVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantA/accounting/expenses/create-expenses/create-page"
    ),
  { ssr: false }
);
const HospitalityManagementExpensesVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantB/accounting/expenses/create-expenses/create-page"
    ),
  { ssr: false }
);
const HospitalityManagementExpensesVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantC/accounting/expenses/create-expenses/create-page"
    ),
  { ssr: false }
);
