        ...
        <div className='flex flex-col gap-2 text-text-secondary dark:text-darkText-2 font-normal text-sm'>
          <div className='flex flex-col'>
            ...
            <ul className='list-disc pl-6'>
              <li>
                Your account does not have the appropriate access level to view
                this content. Some sections are restricted to specific roles
                (e.g., administrators, premium members, or Subscribed Users).
              </li>
            </ul>
          </div>
          <div className='flex flex-col'>
          ...
          <div className='flex flex-col'>
            ...
            <ul className='list-disc pl-6'>
              <li>
                If you&rsquo;re logged in but still can&rsquo;t access the page,
                your account may lack the necessary permissions. Contact
          ...
          <div className='flex flex-col mt-2'>
            ...
            <p>
              ...
              certain areas is restricted. If you believe you should have access
              or need assistance, please contact administrator, to resolve the
