...
const PropertyDeveloperCategoryVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantA/inventories/InventoryRecord"
    ),
  { ssr: false }
);
const PropertyDeveloperCategoryVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantB/inventories/InventoryRecord"
    ),
  { ssr: false }
);
const PropertyDeveloperCategoryVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantC/inventories/InventoryRecord"
    ),
  { ssr: false }
);
...
const HospitalityManagementCategoryVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantA/inventories/InventoryRecord"
    ),
  { ssr: false }
);
const HospitalityManagementCategoryVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantB/inventories/InventoryRecord"
    ),
  { ssr: false }
);
const HospitalityManagementCategoryVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantC/inventories/InventoryRecord"
    ),
  { ssr: false }
);
