...
const PropertyDeveloperCategoryVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantA/inventories/EditSuppliersInfo"
    ),
  { ssr: false }
);
const PropertyDeveloperCategoryVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantB/inventories/EditSuppliersInfo"
    ),
  { ssr: false }
);
const PropertyDeveloperCategoryVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantC/inventories/EditSuppliersInfo"
    ),
  { ssr: false }
);
...
const HospitalityManagementCategoryVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantA/inventories/EditSuppliersInfo"
    ),
  { ssr: false }
);
const HospitalityManagementCategoryVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantB/inventories/EditSuppliersInfo"
    ),
  { ssr: false }
);
const HospitalityManagementCategoryVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantC/inventories/EditSuppliersInfo"
    ),
  { ssr: false }
);
