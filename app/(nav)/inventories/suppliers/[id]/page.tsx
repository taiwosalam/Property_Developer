...
const PropertyDeveloperCategoryVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantA/inventories/SuppliersInfo"
    ),
  { ssr: false }
);
const PropertyDeveloperCategoryVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantB/inventories/SuppliersInfo"
    ),
  { ssr: false }
);
const PropertyDeveloperCategoryVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantC/inventories/SuppliersInfo"
    ),
  { ssr: false }
);
...
const HospitalityManagementCategoryVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantA/inventories/SuppliersInfo"
    ),
  { ssr: false }
);
const HospitalityManagementCategoryVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantB/inventories/SuppliersInfo"
    ),
  { ssr: false }
);
const HospitalityManagementCategoryVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantC/inventories/SuppliersInfo"
    ),
  { ssr: false }
);
