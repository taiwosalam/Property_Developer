...
const PropertyDeveloperCategoryVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantA/inventories/Category"
    ),
  { ssr: false }
);
const PropertyDeveloperCategoryVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantB/inventories/Category"
    ),
  { ssr: false }
);
const PropertyDeveloperCategoryVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantC/inventories/Category"
    ),
  { ssr: false }
);
...
const HospitalityManagementCategoryVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantA/inventories/Category"
    ),
  { ssr: false }
);
const HospitalityManagementCategoryVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantB/inventories/Category"
    ),
  { ssr: false }
);
const HospitalityManagementCategoryVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantC/inventories/Category"
    ),
  { ssr: false }
);
