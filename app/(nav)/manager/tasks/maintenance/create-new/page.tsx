...
} from "@/app/(nav)/tasks/maintenance/create-new/data";
import { createMaintenance } from "@/app/(nav)/tasks/maintenance/data";
  ...
  const goToMainPage = () => {
    switch (role) {
      case "director":
        ...
        break;
      case "manager":
        router.push(`/manager/tasks/maintenance`);
        break;
      case "account":
        router.push(`/accountant/tasks/maintenance`);
        break;
      case "staff":
        router.push(`/staff/tasks/maintenance`);
        break;
      default:
