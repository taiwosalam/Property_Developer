  ...
  const config: AxiosRequestConfig = useMemo(() => {
    ...
    return {
      params: {
        ...
        search,
        sort_by: sort,
        branch_id: branch?.branch_id, // IMPORTANT: filter by branch
      },
    };
  }, [selectedDateRange, search, sort, branch?.branch_id]);
          ...
          <div>
            <div className="flex flex-col">
              ...
              <div className="text-text-disabled flex items-center space-x-1">
                <LocationIcon />
                <p className="text-sm font-medium">{branch.branch_address}</p>
              </div>
            </div>
          </div>
          <Modal>
