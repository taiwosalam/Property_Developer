...
const ManagerLandlord = () => {
  ...
  }, [page, searchQuery, appliedFilters, BRANCH_ID]);
  ...
  const {
    ...
    cache: {
      ...
      key: `landlords-page-${config.params.page}-search-${
        ...
        config.params.states || "none"
      }-branch_ids-${BRANCH_ID}-agent-${config.params.agent || "none"}-dates-${
...
export default ManagerLandlord;
