...
export const getStaffCardData = (staff: Record<string, any>) => [
  {
    ...
    link: `/manager/management/branch-staff/${staff.id}/properties/`,
  },
  {
    title: "Landlords",
    ...
    link: `/manager/management/branch-staff/${staff.id}/landlords/`,
  },
  {
    ...
    link:  `/manager/management/branch-staff/${staff.id}/tenants/`,
  },
];
