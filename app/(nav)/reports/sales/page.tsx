...
const PropertyDeveloperClientReportVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantA/reports/sales/sales"
    ),
  { ssr: false }
);
...
const PropertyDeveloperClientReportVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantB/reports/sales/sales"
    ),
  { ssr: false }
);
...
const PropertyDeveloperClientReportVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantC/reports/sales/sales"
    ),
  { ssr: false }
);
...
const HospitalityManagerClientReportVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantA/reports/sales/sales"
    ),
  { ssr: false }
);
...
const HospitalityManagerClientReportVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantB/reports/sales/sales"
    ),
  { ssr: false }
);
...
const HospitalityManagerClientReportVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantC/reports/sales/sales"
    ),
  { ssr: false }
);
