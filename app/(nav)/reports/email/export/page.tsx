...
// import { emailTablefields, IEmailReportResponse } from "../data";
...
//   const filteredEmails = useGlobalStore((s) => s.emails?.emails);
...
//     isNetworkError,
//     error,
//   } = useFetch<IEmailReportResponse>(`/report/emails`);
...
const PropertyManagerPropertiesReportVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantA/reports/email/export/email"
    ),
  { ssr: false }
);
...
const PropertyManagerPropertiesReportVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantB/reports/email/export/export"
    ),
  { ssr: false }
);
...
const PropertyManagerPropertiesReportVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantC/reports/email/export/export"
    ),
  { ssr: false }
);
...
const HospitalityManagerPropertiesReportVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantA/reports/email/export/export"
    ),
  { ssr: false }
);
...
const HospitalityManagerPropertiesReportVariantB = dynamic(
  () =>
    import(
        "@/components/PAGES/DIRECTOR/HospitalityManager/VariantB/reports/email/export/export"
    ),
  { ssr: false }
);
...
const HospitalityManagerPropertiesReportVariantC = dynamic(
  () =>
    import(
       "@/components/PAGES/DIRECTOR/HospitalityManager/VariantC/reports/email/export/export"
    ),
  { ssr: false }
);

const EmailReportExportPage = () => {
...
export default EmailReportExportPage;
