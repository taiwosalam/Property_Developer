...
const PropertyDeveloperClientReportVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantA/reports/owner/export"
    ),
  { ssr: false }
);
...
const PropertyDeveloperClientReportVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantB/reports/owner/export"
    ),
  { ssr: false }
);
...
const PropertyDeveloperClientReportVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantC/reports/owner/export"
    ),
  { ssr: false }
);
...
const HospitalityManagerClientReportVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantA/reports/owner/export"
    ),
  { ssr: false }
);
...
const HospitalityManagerClientReportVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantB/reports/owner/export"
    ),
  { ssr: false }
);
...
const HospitalityManagerClientReportVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantC/reports/owner/export"
    ),
  { ssr: false }
);
