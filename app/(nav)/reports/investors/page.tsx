...
const PropertyDeveloperClientReportVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantA/reports/investors/investors"
    ),
  { ssr: false }
);
...
const PropertyDeveloperClientReportVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantB/reports/investors/investors"
    ),
  { ssr: false }
);
...
const PropertyDeveloperClientReportVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantC/reports/investors/investors"
    ),
  { ssr: false }
);
...
const HospitalityManagerClientReportVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantA/reports/investors/investors"
    ),
  { ssr: false }
);
...
const HospitalityManagerClientReportVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantB/reports/investors/investors"
    ),
  { ssr: false }
);
...
const HospitalityManagerClientReportVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantC/reports/investors/investors"
    ),
  { ssr: false }
);
