...
const PropertyManagerPropertiesReportVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyManager/variantA/reports/tracking/[userId]/page"
    ),
  { ssr: false }
);
...
const PropertyManagerPropertiesReportVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyManager/VariantB/reports/tracking/[userId]/tracking"
    ),
  { ssr: false }
);
...
const PropertyManagerPropertiesReportVariantC = dynamic(
  () =>
    import(
     "@/components/PAGES/DIRECTOR/PropertyManager/VariantC/reports/tracking/[userId]/userId"
    ),
  { ssr: false }
);
...
const PropertyDeveloperPropertiesReportVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantA/reports/tracking/[userId]/userId"
    ),
  { ssr: false }
);
...
const PropertyDeveloperPropertiesReportVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantB/reports/tracking/[userId]/tracking"
    ),
  { ssr: false }
);
...
const PropertyDeveloperPropertiesReportVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/PropertyDeveloper/VariantC/reports/tracking/[userId]/tracking"
    ),
  { ssr: false }
);
...
const HospitalityManagerPropertiesReportVariantA = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantA/reports/tracking/[userId]/tracking"
    ),
  { ssr: false }
);
...
const HospitalityManagerPropertiesReportVariantB = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantB/reports/tracking/[userId]/tracking"
    ),
  { ssr: false }
);
...
const HospitalityManagerPropertiesReportVariantC = dynamic(
  () =>
    import(
      "@/components/PAGES/DIRECTOR/HospitalityManager/VariantC/reports/tracking/[userId]/tracking"
    ),
  { ssr: false }
);
