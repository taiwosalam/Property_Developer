    ...
    try {
      ...
      if (res) {
        ...
        if (startRentUnitId) {
          ...
          router.push(
            `/accountant/management/rent-unit/${startRentUnitId}/start-rent?type=rental&id=${startRentUnitId}`
          );
          return;
        }
        if (type === "preview")
          router.push(`/accountant/documents/preview/?d=${documentId}`);
        else {
  ...
  return (
    <div className="custom-flex-col gap-10 pb-[100px]">
      <div className="custom-flex-col gap-6">
        <BackButton customBackPath="/accountant/documents">
