...
import StaffProfilePortfolio
    from "@/components/Management/Staff-And-Branches/Branch/StaffProfile/staff-profile-portfolio";
import {
    activitiesTableData,
    getPortfolioData,
    getStaffCardData,
                        ...
                        <div className="flex flex-col xl:flex-row gap-5">
                            ...
                            <div className="custom-flex-col gap-2">
                                <div className="space-y-4">
                                    <div>
                                        <div
                                            className="text-black dark:text-white text-lg lg:text-xl font-bold capitalize flex items-center">
