      ...
      <div className="space-y-4">
        <div className="w-full flex items-center justify-between">
          ...
          <Button
            ...
            onClick={() =>
              router.push("/accountant/accounting/expenses/create-expenses")
            }
          >
            + create Expenses
          </Button>
        ...
        <div className="bg-white rounded-[8px] border border-opacity-20 border-[#BAC7D533] dark:bg-[#3C3D37] dark:border-[#292d32] p-4 space-y-6">
          <div className="flex flex-wrap gap-y-4 items-center justify-between">
            ...
            <FilterBar
              ...
              exports
              noExclamationMark
              exportHref="/accountant/accounting/expenses/export"
        ...
        <>
          {silentLoading ? (
            ...
            <section>
              <EmptyList
                ...
                buttonLink="/accountant/accounting/expenses/create-expenses"
                title="You do not have any expenses yet!"
                body={
                  <p>
          ...
          >
            <MenuItem onClick={handleMenuClose} disableRipple>
              <Link
                href={`/accountant/accounting/expenses/${selectedItemId}/manage-expenses`}
            ...
            <MenuItem onClick={handleMenuClose} disableRipple>
              <Link
                href={`/accountant/accounting/expenses/${selectedItemId}/preview-expenses`}
                className="w-full text-left"
              >
                Preview Expense
              </Link>
